...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen bg-[#09090b] overflow-hidden">
      ...
      <div 
        ref={leftColRef}
        className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-zinc-950 via-zinc-900 to-black border-r border-zinc-900/80 p-16 flex-col items-center justify-between text-center relative"
      >
      ...
      <div 
        ref={rightColRef}
        className="w-full lg:w-1/2 min-h-screen flex items-center justify-center bg-[#09090b] px-4 sm:px-6 lg:px-8 relative"
      >
